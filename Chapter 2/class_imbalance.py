...
plt.figure()
plt.scatter(class_0[:, 0], class_0[:, :1], facecolors = 'black', edgecolors='black', linewidth=1, marker='x')
plt.scatter(class_1[:, 0], class_1[:, :1], facecolors = 'black', edgecolors='black', linewidth=1, marker='o')
